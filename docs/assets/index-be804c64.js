 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UI="FirebaseError";class Pn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=UI,Object.setPrototypeOf(this,Pn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ui.prototype.create)}}class ui{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?$I(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Pn(r,a,s)}}function $I(t,e){return t.replace(BI,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const BI=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=jC;function Lc(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:kl,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw yn.create("bad-app-name",{appName:String(r)});if(n||(n=sg()),!n)throw yn.create("no-options");const i=co.get(r);if(i){if(lo(n,i.options)&&lo(s,i.config))return i;throw yn.create("duplicate-app",{appName:r})}const o=new JI(r);for(const l of Rl.values())o.addComponent(l);const a=new KC(n,s,o);return co.set(r,a),a}function ug(t=kl){const e=co.get(t);if(!e&&t===kl&&sg())return Lc();if(!e)throw yn.create("no-app",{appName:t});return e}function bn(t,e,n){var s;let r=(s=HC[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Qt.warn(a.join(" "));return}Ks(new ts(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zC="firebase-heartbeat-database",qC=1,Qr="firebase-heartbeat-store";let La=null;function dg(){return La||(La=uC(zC,qC,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Qr)}catch(n){console.warn(n)}}}}).catch(t=>{throw yn.create("idb-open",{originalErrorMessage:t.message})})),La}async function GC(t){try{const n=(await dg()).transaction(Qr),s=await n.objectStore(Qr).get(fg(t));return await n.done,s}catch(e){if(e instanceof Pn)Qt.warn(e.message);else{const n=yn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Qt.warn(n.message)}}}async function uf(t,e){try{const s=(await dg()).transaction(Qr,"readwrite");await s.objectStore(Qr).put(e,fg(t)),await s.done}catch(n){if(n instanceof Pn)Qt.warn(n.message);else{const s=yn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Qt.warn(s.message)}}}function fg(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hT(t,e){return Nn(t,"POST","/v1/accounts:delete",e)}async function yg(t,e){return Nn(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jr(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Pn&&gT(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function gT({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function CT(t,e={}){return Nn(t,"GET","/v2/passwordPolicy",xn(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HT(t,e){return fi(t,"POST","/v1/accounts:signInWithPassword",xn(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WT(t,e){return fi(t,"POST","/v1/accounts:signInWithEmailLink",xn(t,e))}async function VT(t,e){return fi(t,"POST","/v1/accounts:signInWithEmailLink",xn(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ms(t,e){return fi(t,"POST","/v1/accounts:signInWithIdp",xn(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GT(t,e){return fi(t,"POST","/v1/accounts:signUp",xn(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function NS(t,e={}){return Nn(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wm=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new eR(e)}}catch{}return new tR},Vn=wm("localStorage"),Fl=wm("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function la(t,e){return{eventCache:t,serverCache:e}}function Dr(t,e,n,s){return la(new Rn(e,n,s),t.serverCache)}function n_(t,e,n,s){return la(t.eventCache,new Rn(e,n,s))}function Io(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function os(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FA{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const l_=new FA;class gu{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new Rn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return pu(this.writes_,e,s)}}getChildAfterChild(e,n,s){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:os(this.viewCache_),i=DA(this.writes_,r,n,1,s,e);return i.length===0?null:i[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ko;class d_{constructor(){this.views=new Map}}function XA(t){T(!ko,"__referenceConstructor has already been defined"),ko=t}function ZA(){return T(ko,"Reference.ts has not been loaded"),ko}function eP(t){return t.views.size===0}function mu(t,e,n,s){const r=e.source.queryId;if(r!==null){const i=t.views.get(r);return T(i!=null,"SyncTree gave us an op for an invalid query."),hh(i,e,n,s)}else{let i=[];for(const o of t.views.values())i=i.concat(hh(o,e,n,s));return i}}function f_(t,e,n,s,r){const i=e._queryIdentifier,o=t.views.get(i);if(!o){let a=Co(n,r?s:null),l=!1;a?l=!0:s instanceof K?(a=hu(n,s),l=!1):(a=K.EMPTY_NODE,l=!1);const c=la(new Rn(a,l,!1),new Rn(s,r,!1));return new zA(e,c)}return o}function tP(t,e,n,s,r,i){const o=f_(t,e,s,r,i);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),QA(o,n),JA(o,n)}function nP(t,e,n,s){const r=e._queryIdentifier,i=[];let o=[];const a=An(t);if(r==="default")for(const[l,c]of t.views.entries())o=o.concat(fh(c,n,s)),dh(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||i.push(c.query));else{const l=t.views.get(r);l&&(o=o.concat(fh(l,n,s)),dh(l)&&(t.views.delete(r),l.query._queryParams.loadsAllData()||i.push(l.query)))}return a&&!An(t)&&i.push(new(ZA())(e._repo,e._path)),{removed:i,events:o}}function h_(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function En(t,e){let n=null;for(const s of t.views.values())n=n||YA(s,e);return n}function p_(t,e){if(e._queryParams.loadsAllData())return ua(t);{const s=e._queryIdentifier;return t.views.get(s)}}function g_(t,e){return p_(t,e)!=null}function An(t){return ua(t)!=null}function ua(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ro;function sP(t){T(!Ro,"__referenceConstructor has already been defined"),Ro=t}function rP(){return T(Ro,"Reference.ts has not been loaded"),Ro}let iP=1;class ph{constructor(e){this.listenProvider_=e,this.syncPointTree_=new be(null),this.pendingWriteTree_=MA(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function m_(t,e,n,s,r){return IA(t.pendingWriteTree_,e,n,s,r),r?yi(t,new is(t_(),e,n)):[]}function Kn(t,e,n=!1){const s=CA(t.pendingWriteTree_,e);if(TA(t.pendingWriteTree_,e)){let i=new be(null);return s.snap!=null?i=i.set(oe(),!0):st(s.children,o=>{i=i.set(new pe(o),!0)}),yi(t,new Eo(s.path,i,n))}else return[]}function vi(t,e,n){return yi(t,new is(du(),e,n))}function oP(t,e,n){const s=be.fromObject(n);return yi(t,new ai(du(),e,s))}function aP(t,e){return yi(t,new oi(du(),e))}function lP(t,e,n){const s=vu(t,n);if(s){const r=yu(s),i=r.path,o=r.queryId,a=ze(i,e),l=new oi(fu(o),a);return bu(t,i,l)}else return[]}function Ao(t,e,n,s,r=!1){const i=e._path,o=t.syncPointTree_.get(i);let a=[];if(o&&(e._queryIdentifier==="default"||g_(o,e))){const l=nP(o,e,n,s);eP(o)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(f=>f._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(i,(f,p)=>An(p));if(u&&!d){const f=t.syncPointTree_.subtree(i);if(!f.isEmpty()){const p=dP(f);for(let g=0;g<p.length;++g){const _=p[g],v=_.query,I=b_(t,_);t.listenProvider_.startListening(Fr(v),li(t,v),I.hashFn,I.onComplete)}}}!d&&c.length>0&&!s&&(u?t.listenProvider_.stopListening(Fr(e),null):c.forEach(f=>{const p=t.queryToTagMap.get(da(f));t.listenProvider_.stopListening(Fr(f),p)}))}fP(t,c)}return a}function __(t,e,n,s){const r=vu(t,s);if(r!=null){const i=yu(r),o=i.path,a=i.queryId,l=ze(o,e),c=new is(fu(a),l,n);return bu(t,o,c)}else return[]}function cP(t,e,n,s){const r=vu(t,s);if(r){const i=yu(r),o=i.path,a=i.queryId,l=ze(o,e),c=be.fromObject(n),u=new ai(fu(a),l,c);return bu(t,o,u)}else return[]}function zl(t,e,n,s=!1){const r=e._path;let i=null,o=!1;t.syncPointTree_.foreachOnPath(r,(f,p)=>{const g=ze(f,r);i=i||En(p,g),o=o||An(p)});let a=t.syncPointTree_.get(r);a?(o=o||An(a),i=i||En(a,oe())):(a=new d_,t.syncPointTree_=t.syncPointTree_.set(r,a));let l;i!=null?l=!0:(l=!1,i=K.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((p,g)=>{const _=En(g,oe());_&&(i=i.updateImmediateChild(p,_))}));const c=g_(a,e);if(!c&&!e._queryParams.loadsAllData()){const f=da(e);T(!t.queryToTagMap.has(f),"View does not exist, but we have a tag");const p=hP();t.queryToTagMap.set(f,p),t.tagToQueryMap.set(p,f)}const u=ca(t.pendingWriteTree_,r);let d=tP(a,e,n,u,i,l);if(!c&&!o&&!s){const f=p_(a,e);d=d.concat(pP(t,e,f))}return d}function _u(t,e,n){const r=t.pendingWriteTree_,i=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=ze(o,e),c=En(a,l);if(c)return c});return i_(r,e,i,n,!0)}function uP(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const d=ze(c,n);s=s||En(u,d)});let r=t.syncPointTree_.get(n);r?s=s||En(r,oe()):(r=new d_,t.syncPointTree_=t.syncPointTree_.set(n,r));const i=s!=null,o=i?new Rn(s,!0,!1):null,a=ca(t.pendingWriteTree_,e._path),l=f_(r,e,a,i?o.getNode():K.EMPTY_NODE,i);return GA(l)}function yi(t,e){return v_(e,t.syncPointTree_,null,ca(t.pendingWriteTree_,oe()))}function v_(t,e,n,s){if(X(t.path))return y_(t,e,n,s);{const r=e.get(oe());n==null&&r!=null&&(n=En(r,oe()));let i=[];const o=J(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=o_(s,o);i=i.concat(v_(a,l,c,u))}return r&&(i=i.concat(mu(r,t,s,n))),i}}function y_(t,e,n,s){const r=e.get(oe());n==null&&r!=null&&(n=En(r,oe()));let i=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=o_(s,o),u=t.operationForChild(o);u&&(i=i.concat(y_(u,a,l,c)))}),r&&(i=i.concat(mu(r,t,s,n))),i}function b_(t,e){const n=e.query,s=li(t,n);return{hashFn:()=>(qA(e)||K.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return s?lP(t,n._path,s):aP(t,n._path);{const i=cR(r,n);return Ao(t,n,null,i)}}}}function li(t,e){const n=da(e);return t.queryToTagMap.get(n)}function da(t){return t._path.toString()+"$"+t._queryIdentifier}function vu(t,e){return t.tagToQueryMap.get(e)}function yu(t){const e=t.indexOf("$");return T(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new pe(t.substr(0,e))}}function bu(t,e,n){const s=t.syncPointTree_.get(e);T(s,"Missing sync point for query tag that we're tracking");const r=ca(t.pendingWriteTree_,e);return mu(s,n,r,null)}function dP(t){return t.fold((e,n,s)=>{if(n&&An(n))return[ua(n)];{let r=[];return n&&(r=h_(n)),st(s,(i,o)=>{r=r.concat(o)}),r}})}function Fr(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(rP())(t._repo,t._path):t}function fP(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const r=da(s),i=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(i)}}}function hP(){return iP++}function pP(t,e,n){const s=e._path,r=li(t,e),i=b_(t,n),o=t.listenProvider_.startListening(Fr(e),r,i.hashFn,i.onComplete),a=t.syncPointTree_.subtree(s);if(r)T(!An(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!X(c)&&u&&An(u))return[ua(u).query];{let f=[];return u&&(f=f.concat(h_(u).map(p=>p.query))),st(d,(p,g)=>{f=f.concat(g)}),f}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(Fr(u),li(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fx(t){Zk(rr),Ks(new ts("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return ax(s,r,i,n)},"PUBLIC").setMultipleInstances(!0)),bn(Bf,jf,t),bn(Bf,jf,"esm2017")}qt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};qt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};fx();const hx={name:"TaskList",components:{MainHeader:Xk,Icon:Ac},setup(){const t=Z({}),e=Z(!1),n=Z(""),s=Z(null),r=Fu();let i=null;const o=Zr().onAuthStateChanged(u=>{u?(s.value=u.uid,a()):(s.value=null,t.value={},i&&(zn(r,"tasks").off("value",i),i=null))});function a(){e.value=!0,i&&i();const u=sx(zn(r,"tasks"),ex("userUID"),nx(s.value));i=B_(u,d=>{t.value=d.val()||{},e.value=!1})}function l(){!s.value||!n.value.trim()||zn(r,"tasks").push({taskText:n.value,userUID:s.value}).then(()=>{n.value=""}).catch(u=>{console.error("Error adding task:",u)})}function c(u){const d=zn(r,"tasks"),f=as(d,u);YP(f).then(p=>{const g=p.val();g&&g.userUID===s.value?$_(f).then(()=>console.log("Task removed!")).catch(_=>console.error("Error removing task:",_)):console.error("Access denied: task doesn't belong to user.")}).catch(p=>{console.error("Error fetching task data:",p)})}return Bo(()=>{i&&i(),o()}),{taskArray:t,isLoading:e,newTaskText:n,addTask:l,deleteTask:c}}},px=t=>(Yh("data-v-5da03bc3"),t=t(),Qh(),t),gx={class:"dark:bg-gray-900 min-h-screen p-4"},mx={key:0,class:"flex justify-center items-center h-32"},_x=px(()=>se("div",{class:"spinner"},null,-1)),vx=[_x],yx={key:1,class:"flex justify-center"},bx={class:"task-list"},wx=["onClick"];function Ex(t,e,n,s,r,i){const o=Ke("main-header"),a=Ke("Icon");return Be(),Je("div",gx,[le(o),s.isLoading?(Be(),Je("div",mx,vx)):(Be(),Je("div",yx,[se("ul",bx,[(Be(!0),Je(Le,null,_y(s.taskArray,(l,c)=>(Be(),Je("li",{key:c,class:"task-item"},[se("span",null,Gi(l.taskText),1),se("button",{onClick:u=>s.deleteTask(c),class:"delete-btn"},[le(a,{icon:"mdi-light:delete"})],8,wx)]))),128))])]))])}const Ix=Lt(hx,[["render",Ex],["__scopeId","data-v-5da03bc3"]]),Cx={},Tx=se("br",null,null,-1),Sx={class:"rounded-xl shadow-md p-10 w-fit mx-auto m-32-auto place-content-center grid place-items-center dark:bg-sky-950"};function kx(t,e){return Be(),Je(Le,null,[Tx,se("div",Sx,[jo(t.$slots,"default")])],64)}const j_=Lt(Cx,[["render",kx]]),Rx={components:{ContentBox:j_,BaseHeader:zc}},Ax=se("div",{class:"py-0 px-3 font-semibold dark:text-white"},"Task Project",-1),Px=se("h2",{class:"font-semibold p-4 dark:text-white"},"Page Not Found",-1),xx={class:"dark:text-white"};function Nx(t,e,n,s,r,i){const o=Ke("base-header"),a=Ke("router-link"),l=Ke("content-box");return Be(),Je(Le,null,[le(o,null,{default:at(()=>[Ax]),_:1}),se("section",null,[le(l,{class:"dark:bg-sky-950"},{default:at(()=>[Px,se("div",xx,[_n(" This page could not be found - do you want to return to "),le(a,{to:"/login",class:"underline underline-offset-2"},{default:at(()=>[_n("login")]),_:1}),_n("? ")])]),_:1})])],64)}const Ox=Lt(Rx,[["render",Nx]]),Mx=oE({history:Ew(),routes:[{path:"/",redirect:"login"},{path:"/login",component:kk},{path:"/tasks",component:Ix},{path:"/:notFound(.*)",component:Ox}]});var Dx="firebase",Lx="11.3.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
