<template>
  <form>
    <!-- <div>
      ...
      <input type="text" for="username" v-model="username" class="border-black border-solid"/>
    </div>
    <div>
      <label for="password" class="font-medium text-xl" min="6" max="15">Password:</label>
      <input type="password" for="password" v-model="password" class="out-of-range:border-red-500 border-black border-solid"/>
    </div> -->
